...
The currently recognized format options are:
	...
	public List<String> getUrls(LayerRequest layer) throws MalformedURLException, JsonParseException{
	 ...
	 Map<String, String> getWfsDescribeLayerInfo()
		...
		InputStream inputStream = this.httpRequester.sendRequest(this.checkUrl(this.currentLayer.getWfsUrl()), ogcInfoRequest.createRequest(layerName), ogcInfoRequest.getMethod());
