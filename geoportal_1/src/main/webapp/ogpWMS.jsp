...
/*
      <Layer queryable="1">
        <Name>sde:GISPORTAL.GISOWNER01.ESRI_CITIES</Name>
        <Title>GISPORTAL.GISOWNER01.ESRI_CITIES</Title>
        <Abstract/>
        <KeywordList/>
        <SRS>EPSG:4326</SRS>
...
GEOGCS["WGS 84", 
  ...
  AUTHORITY["EPSG","4326"]]-->
        <LatLonBoundingBox minx="-176.152" miny="-54.792" maxx="179.222" maxy="78.2"/>
        <BoundingBox SRS="EPSG:4326" minx="-176.152" miny="-54.792" maxx="179.222" maxy="78.2"/>
        <Style>
          <Name>point</Name>
          ...
          <LegendURL width="20" height="20">
            ...
            <OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="http://geoserver-dev.atech.tufts.edu:80/wms?request=GetLegendGraphic&amp;format=image%2Fpng&amp;width=20&amp;height=20&amp;layer=GISPORTAL.GISOWNER01.ESRI_CITIES"/>
          </LegendURL>
        </Style>
      </Layer>
*/
	    System.out.println("Layers found...");%><?xml version="1.0" encoding="UTF-8"?>
<%out.write("<!DOCTYPE WMT_MS_Capabilities SYSTEM \"" + serverName + "/schemas/wms/1.1.1/WMS_MS_Capabilities.dtd\">");%>
<WMT_MS_Capabilities version="1.1.1" updateSequence="227">
  <Service>
    <Name>OGC:WMS</Name>
    <Title>OpenGeoportal Web Map Service</Title>
    <Abstract>A dynamically created capabilites document including only certain layers.  For use in a mapping client that supports WMS services.</Abstract>
    <KeywordList>
      <Keyword>WFS</Keyword>
      <Keyword>WMS</Keyword>
      <Keyword>OpenGeoportal</Keyword>
    </KeywordList>
    ...
    <ContactInformation>
      <ContactPersonPrimary>
        <ContactPerson>Geoportal Development Team</ContactPerson>
        <ContactOrganization>Tufts University</ContactOrganization>
      </ContactPersonPrimary>
      <ContactPosition/>
      <ContactAddress>
      ...
      <ContactElectronicMailAddress>atsystems@elist.tufts.edu</ContactElectronicMailAddress>
    </ContactInformation>
    <Fees>NONE</Fees>
  ...
  <Capability>
    <Request>
      <GetCapabilities>
        ...
        <DCPType>
          <HTTP>
            <Get>
              <OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="<%out.write(servicePoint);%>?SERVICE=WMS&amp;"/>
            </Get>
            <Post>
              <OnlineResource xmlns:xlink="http://www.w3.org/1999/xlink" xlink:type="simple" xlink:href="<%out.write(servicePoint);%>?SERVICE=WMS&amp;"/>
            </Post>
    ...
    <Layer>
      <Title>OpenGeoportal Dynamic Web Map Service</Title>
      ...
      <SRS>EPSG:42304</SRS>
      <SRS>EPSG:42303</SRS>
      <LatLonBoundingBox minx="-179.152" miny="-80" maxx="179.222" maxy="80"/>
	  <% out.write(featureTypeInfo); %></Layer>
  </Capability>
</WMT_MS_Capabilities>
